...
from dataset import MultiResolutionDataset, SatelliteDataset
...
if __name__ == "__main__":
    ...
    print(args.size, args.latent, args.n_mlp, args.channel_multiplier)
    generator = Generator(
    ...
    dataset = SatelliteDataset(rootdir='../data_p005/NWPU-RESISC45',
                          train=True,
                          download=False,
                          transform=transforms.Compose([
                              transforms.ToTensor(),
